(function($){
	...
	$( document ).ready( function() {
		...
		//height and width background castom////
		...
		let $filterList = $('.tabs-filter-list__btn'),
		...
		$filterList.each( function(){
			...
			////function ajax inquiry database and nunjack render///////
		function showData(category) {
			...
			$.ajax({
				...
				success: function(products) {
					...
					jQuery.each(productsDB, function(i) {
		...
		let allUsersData = {},
			...
			///////////handler login form/////////
		$('.loginButton', $loginForm ).on('click', function() {
